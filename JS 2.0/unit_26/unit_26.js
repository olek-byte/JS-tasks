...
function t6() {
  fetch("http://getpost.itgid.info/index2.php?auth=DdC33D7d2C2a7&action=6&num1=3&num2=7")
    .then(data => {
      return data.text()
    })
    .then(data => {
...
function t12() {
  fetch("http://getpost.itgid.info/index2.php", {
      ...
      body: 'auth=DdC33D7d2C2a7&action=3&num1=2&num2=5'
    })
    .then(response => response.text())
    .then(response => {
...
function t13() {
  fetch("http://getpost.itgid.info/index2.php", {
      ...
      body: 'auth=DdC33D7d2C2a7&action=4&num1=2&num2=5'
    })
    .then(response => response.text())
    .then(response => {
...
function t15() {
  fetch("http://getpost.itgid.info/index2.php", {
      ...
      body: 'auth=DdC33D7d2C2a7&action=6&num1=2&num2=5'
    })
    .then(response => response.text())
    .then(response => {

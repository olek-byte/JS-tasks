...
let divs = document.querySelectorAll('.out-10');
...
// let btn = document.querySelector('.btn21');

// btn.onclick = () => {
//     console.log('HIIII');
//     // this.style.color = 'red';
//     btn.classList.toggle('bg-orange');
// }

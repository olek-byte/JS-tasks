...
function t9() {
    ...
    if (input1.value > input2.value) {
        let t = input1.value;
        input1.value = input2.value; // если бы мы не сохранили значение a исходное - то после этой операции оно бы пропало
        input2.value = t;
    }
    for (let i = input1.value; i <= input2.value; i++) {
        out += `${i}_`;
...
function t12() {
    ...
    for (let i = 0; i < div.length; i++) {
        ...
        //console.log(div[i].style.background = 'orange');
    }
}

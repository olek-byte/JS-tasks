...
function t12() {
    let name1 = document.querySelector('.i-12-1').value;
    let name2 = document.querySelector('.i-12-2').value;
    // document.querySelector('.out-12').innerHTML = 'Hello' + ' ' + name1 + ' ' + name2;
    document.querySelector('.out-12').innerHTML = `Hello ${"name1"} ${"name2"}`;
}
...
//     let a = document.querySelector('.i-21').value;
//     console.log(a);
//     document.querySelector('.out-21').innerHTML += a;
// }

// document.querySelector('.b-21').addEventListener('click', myClick);
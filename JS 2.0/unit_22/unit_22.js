...
function t2() {
    ...
    let b = 5;
    try {
        document.querySelector('.out-22222').innerHTML = a * b;
    } catch {
...
function t3() {
    ...
    try {
        ...
        let out = document.createElement('div'); //создал блок
        out.classList.add('out-3'); // присвоил класс
        document.querySelector('.three').append(out); // втянул в необходимый контейнер
        document.querySelector('.out-3').innerHTML = a * b; // вывод в новосозданный блок
    }
}

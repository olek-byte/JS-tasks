...
function f1() {
    //first option without optimisation
...
function f18() {
    ...
    document.querySelector('.out-18').innerHTML = d18.includes(value);
}
...
function f20() {
    document.querySelector('.out-20').innerHTML = d20.join('_');
}

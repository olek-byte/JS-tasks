...
const f7 = () => {
    a7_res = a7.map((item, index, array) => {
        return array.length;
...
const f8 = () => {
    a8_res = a8.map((item, index, array) => {
        let a = 0;

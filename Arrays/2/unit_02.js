...
const f1 = () => {
    ...
    out.innerHTML = a1.includes(value);
    // console.log(a1.includes(value));
}
...
const f2 = () => {
    ...
    if (a2.includes(value)) {
        out.innerHTML = a2.indexOf(value);
    } else {
        out.innerHTML = false;
    }
}
...
const f5 = () => {
    ...
    out.innerHTML = a5.includes(elem, index);
}
...
const f6 = () => {
    ...
    out.innerHTML = a6.includes(value);
}
...
const f8 = () => {
    ...
    out.innerHTML = a8.includes(value);
}
...
const f9 = () => {
    // console.log('09');
    let value = document.querySelector('.i-9').value.toLowerCase();
    let tmp = a9.map(item => String(item).toLowerCase());
    let out = document.querySelector('.out-9');
    out.innerHTML = tmp.includes(value);
}
...
const a11 = [
    ...
    true, '', [1], Infinity, undefined, null, NaN
];

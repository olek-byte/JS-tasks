...
const f1 = () => {
    ...
    out.innerHTML = a1.indexOf(value);
}
...
const f4 = (arr, elem) => {
    ...
    out.innerHTML = arr.indexOf(elem);
}
...
const f5 = () => {
    ...
    // console.log(a5.indexOf(elem, index));
    out.innerHTML = a5.indexOf(elem, index);
}
...
const f6 = () => {
    ...
    // console.log(a6.indexOf(elem));
    document.querySelector('.out-6').innerHTML = a6.indexOf(elem);
}
...
document.querySelector('.b-10').addEventListener('click', () => {
    document.querySelector('.out-10').innerHTML = f10(a10, 66);
});